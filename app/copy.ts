...
export const copy = {
  ...
  zh: {
    ...
    archive: {
      meta: "2026 — 持续更新",
      title: "一个持续生长的技术美术归档。",
      body: "把未来一年会持续补充的作品、笔记和实验，都收在这一个可展开的入口里。",
      link: "查看当前归档",
      activeLabel: "进行中的方向",
      nextLabel: "接下来会补充",
      active: [
    ...
    workBody:
      "精选 Unity 实践，按清晰的视觉叙事呈现：最终效果、实现逻辑、节点结构，以及已有的源码。",
    highlightsEyebrow: "先看重点",
    highlightsTitle: "精选视觉系统。",
    highlightsHint: "选一个案例，展开完整拆解。",
    highlights: [
      { promise: "一条时间线，四段视觉节拍。", metric: "04", metricLabel: "特效阶段" },
      { promise: "记得住每一次击中的护盾。", metric: "02", metricLabel: "涟漪通道" },
      { promise: "流动、扭曲与辉光，汇成一束光。", metric: "10", metricLabel: "节点研究" },
      { promise: "像在燃烧的溶解边缘。", metric: "04", metricLabel: "核心模块" },
    ],
    ...
    contactCards: [
      ["直接联系", "Email", "ke4773613@gmail.com"],
