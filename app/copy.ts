...
export const copy = {
  en: {
    ...
    highlights: [
      { promise: "One timeline. Four visual beats.", metric: "04", metricLabel: "VFX stages" },
      { promise: "A shield that remembers every hit.", metric: "02", metricLabel: "Ripple slots" },
      { promise: "Flow, distortion, and glow in one beam.", metric: "10", metricLabel: "Node studies" },
      { promise: "A dissolve edge that reads as fire.", metric: "04", metricLabel: "Core modules" },
    ],
  ...
  zh: {
    ...
    highlights: [
      { promise: "一条时间线，四段视觉节拍。", metric: "04", metricLabel: "特效阶段" },
      { promise: "记得住每一次击中的护盾。", metric: "02", metricLabel: "涟漪通道" },
      { promise: "流动、扭曲和辉光，汇进同一束光。", metric: "10", metricLabel: "节点研究" },
      { promise: "溶解的边缘，看着像在烧。", metric: "04", metricLabel: "核心模块" },
    ],
